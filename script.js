...
const translations = {
  en: {
    ...
    loc_dakar_title: "Senegal Operations Hub",
    loc_dakar_desc: "Avenue Cheikh Anta Diop, Dakar, Republic of Senegal",
  ...
  ar: {
    ...
    loc_dakar_title: "مركز عمليات السنغال",
    loc_dakar_desc: "شارع الشيخ أنتا ديوب، دكار، جمهورية السنغال",
